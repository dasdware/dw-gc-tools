...
import { sidebarStyle, sidebarClasses } from "../styles/sidebar";
...
export const Sidebar: FunctionalComponent<SidebarProps> = (props) => {
    const result = (!props.controller.northFormula.haveError && !props.controller.eastFormula.haveError)
    ? <div class="result">
    ...
    return (
        <div className={sidebarClasses(props.controller.view === AppView.SETTINGS)} style="z-index: 9999">
            <div className={sidebarStyle.content}>
                <h1 className={sidebarStyle.mainHeader}>
                    ...
                    <div className={sidebarStyle.headerActions}>
                        <Button icon={faMap} onClick={() => props.controller.toggleView()} />    
                    </div>                    
                </h1>
