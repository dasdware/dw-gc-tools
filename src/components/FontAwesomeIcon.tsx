...
const convert: (createElement: any, element: any, extraProps: any) => any = (
  createElement,
  element,
  extraProps = {}
) => {
...
export const FontAwesomeIcon: FunctionalComponent<FontAwesomeIconProps> = (
  props
) => {
  ...
  Object.keys(props).forEach((key) => {
    if (!FontAwesomeIcon.defaultProps!.hasOwnProperty(key))
      extraProps[key] = (props as any)[key];
  });
