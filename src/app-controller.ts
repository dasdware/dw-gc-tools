...
export class AppController {
  ...
  constructor() {
    ...
    this.northFormula = new CoordinateFormula(
      this._state.northFormula,
      (value) => this.setNorthFormula(value)
    );
    this.eastFormula = new CoordinateFormula(this._state.eastFormula, (value) =>
      this.setEastFormula(value)
    );

    this.variables = new Variables(
      this._state.variables
        .toArray()
        .map((value) => new Variable(value[0], value[1], false, true)),
